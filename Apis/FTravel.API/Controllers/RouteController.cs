...
namespace FTravel.API.Controllers
{
    ...
    public class RouteController : ControllerBase
    {
        ...
        [HttpGet]
        [Authorize]
        public async Task<IActionResult> GetListRoute([FromQuery] PaginationParameter paginationParameter, [FromQuery] RouteFilter routeFilter)
        {
            try
            {
                var result = await _routeService.GetListRouteAsync(paginationParameter, routeFilter);
                if (result == null)
                {
