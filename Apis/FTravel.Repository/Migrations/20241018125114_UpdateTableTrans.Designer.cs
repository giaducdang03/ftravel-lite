...
namespace FTravel.Repository.Migrations
{
    ...
    [Migration("20241018125114_UpdateTableTrans")]
    partial class UpdateTableTrans
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FTravel.Repository.EntityModels.Wallet", b =>
                {
                    b.HasOne("FTravel.Repository.EntityModels.User", "User")
                        .WithOne("Wallet")
                        .HasForeignKey("FTravel.Repository.EntityModels.Wallet", "UserId")
