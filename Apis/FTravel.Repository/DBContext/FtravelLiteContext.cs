...
public partial class FtravelLiteContext : DbContext
{
    public FtravelLiteContext()
    {
    }

    public FtravelLiteContext(DbContextOptions<FtravelLiteContext> options)
        : base(options)
    {
    }
...
//        => optionsBuilder.UseSqlServer("Server=(local);Uid=sa;Pwd=123456789;Database=FTravel_Lite;TrustServerCertificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Trip>(entity =>
        {
            ...
            entity.Property(e => e.ActualEndDate).HasColumnType("datetime2");
            entity.Property(e => e.ActualStartDate).HasColumnType("datetime2");
            entity.Property(e => e.CreateDate)
                .HasDefaultValueSql("(getdate())")
                .HasColumnType("datetime2");
            entity.Property(e => e.EstimatedEndDate).HasColumnType("datetime2");
            entity.Property(e => e.EstimatedStartDate).HasColumnType("datetime2");
            entity.Property(e => e.Name).HasMaxLength(100);
            entity.Property(e => e.OpenTicketDate).HasColumnType("datetime2");
            entity.Property(e => e.Status).HasMaxLength(50);
            entity.Property(e => e.UnsignName).HasMaxLength(100);
            entity.Property(e => e.UpdateDate).HasColumnType("datetime2");
