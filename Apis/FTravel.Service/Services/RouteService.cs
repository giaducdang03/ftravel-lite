...
namespace FTravel.Service.Services
{
    public class RouteService : IRouteService
    {
        ...
        public async Task<Pagination<RouteModel>> GetListRouteAsync(PaginationParameter paginationParameter, RouteFilter routeFilter)
        {
            var routes = await _routeRepository.GetListRoutesAsync(paginationParameter, routeFilter);

            var routeModels = _mapper.Map<Pagination<RouteModel>>(routes);
